  ...
  return (
    <div className={`relative w-full md:px-10 ${iceland.className}`} ref={containerRef}>
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10 relative z-10">
        ...
        <h1 className="text-2xl md:text-5xl lg:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#ea623e] via-[#934d76] to-[#632182] relative z-2 w-max">
  Timeline
</h1>
